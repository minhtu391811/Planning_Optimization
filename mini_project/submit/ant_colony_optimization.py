...
def generate_solution(T, N, classes, teachers, subjects, periods, pheromones, alpha=0.75, beta=2.0):
    schedule = []
    ...
    for cls in range(1, N + 1):
        for sub in classes[cls]:
            ...
            assigned_classes[cls].append((sub, start_period))
            assigned_teachers[teacher].append((sub, start_period))
...
def ant_colony_optimization(T, N, M, classes, teachers, subjects, periods, num_ants=20, iterations=100):
